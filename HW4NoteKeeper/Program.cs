...
namespace HW4NoteKeeper
{
    public partial class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var storageAccountSettings = builder.Configuration.GetSection("StorageAccountSettings").Get<HW4NoteKeeper.Settings.StorageAccountSettings>();
            ...
            builder.Services.AddSingleton<HW4NoteKeeper.Data.IAzureStorageInitializer, HW4NoteKeeper.Data.AzureStorageInitializer>();
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                try
                {
                    ...
                    var storageInitializer = services.GetRequiredService<HW4NoteKeeper.Data.IAzureStorageInitializer>();
                    ...
                    var dbInitializer = new HW4NoteKeeper.Data.DbInitializer(
                        context, chatClient, aiSettings, 
                        services.GetRequiredService<ILogger<HW4NoteKeeper.Data.DbInitializer>>(), 
